...
for filt in range (len(all_filter_type)):
    ...
    filter_max=0
    if filter_type=="notch_filter_0.40_dssp_noise_free":
        filter_max=40

    if filter_type=="notch_filter_0.25_dssp_noise_free":
        filter_max=25

    if filter_type=="notch_filter_0.60_dssp_noise_free":
        filter_max=60    
    print(filter_type)
...
#     t[0:8]=np.linspace(0,200,8)
    ...
    raw_file_no_filter="/home/ntsikelelo/Simulated_data_files/UVH5_files/Raw_data_no_noise.uvh5"
