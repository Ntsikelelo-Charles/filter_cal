...
raw_file=path+"Raw_data_filtered_Gaussian_fix.uvh5"
...
for step in range (len(mode_array)):
    ...
    if mode=="complete_Gaussian_filter":                   
        model_file=path+"Model_complete_filtered_Gaussian_fix.uvh5"


        
    if mode=="incomplete_Gaussian_filter_baseline_cut":
        model_file=path+"Model_incomplete_filtered_Gaussian_fix.uvh5"
